  ...
  return (
    <AuthLayout title="Identificação">
      ...
      <div className="mt-6 text-center">
        <Link to="/request-password-reset" className="text-xs font-bold text-neutral-500 dark:text-neutral-400 uppercase tracking-widest hover:text-[#d90429] dark:hover:text-[#d90429] transition-colors">
          Esqueceu sua senha?
        </Link>
      </div>

      <div className="mt-6 pt-6 border-t-4 border-neutral-900 dark:border-white text-center">
