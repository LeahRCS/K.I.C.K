          ...
          <div className="lg:col-span-8">
            ...
            >
              ...
              <p className="text-lg md:text-xl lg:text-2xl font-medium text-neutral-700 dark:text-neutral-300 max-w-2xl mb-8 md:mb-10 leading-relaxed">
                Uma plataforma acadêmica e curatorial para gerenciamento de acervo cultural. Estruturamos, organizamos e preservamos a memória do que você decide que é cultura.
              </p>
